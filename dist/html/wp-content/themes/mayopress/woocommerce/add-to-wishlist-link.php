...
<div id="wl-wrapper" class="woocommerce wl-button-wrap wl-row wl-clear <?php echo $class_name; ?>">
  ...
  <a rel="nofollow" href="" data-productid="<?php echo $product->get_id(); ?>" data-listid="<?php echo $add_to_wishlist_args['single_id']; ?>" class="<?php echo implode( ' ', $add_to_wishlist_args['btn_class'] ); ?>">
    <svg class="icon icon--heart" aria-hidden="true" focusable="false"><use xlink:href="#heart"></use></svg>
    <span><?php echo apply_filters( 'woocommerce_wishlist_add_to_wishlist_text', WC_Wishlists_Settings::get_setting( 'wc_wishlist_button_text', __( 'Add to Wishlist', 'wc_wishlist' ) ), $product->get_type() ); ?></span>
  </a>
</div>
