...
<div id="wl-wrapper" class="product woocommerce">
  <!-- product class so woocommerce stuff gets applied in tabs -->

  <div class="my-account__header">
    <h1 id="my-account-header"><?php echo _e('My Account', 'mayo'); ?></h1>
    <a id="my-account-header-sign-out"
      href="<?php echo esc_url( wc_logout_url() ); ?>"><?php echo _e('( sign out )', 'mayo'); ?></a>
  </div>
...
do_action( 'woocommerce_account_navigation' ); ?>
  ...
  <div class="wl-intro">
    ...
    <div class="wl-share-url">
      <strong><?php _e( 'Wishlist URL:', 'wc_wishlist' ); ?>
      </strong><?php echo $wishlist->the_url_view( $sharing == 'Shared' ); ?>
    </div>
    <?php endif; ?>
    <?php if ( $sharing == 'Public' || $sharing == 'Shared' ) : ?>
    ...
    <div class="wl-intro-delete-container">
      <p class="wldelete-btn">
        <a class="btn wlconfirm"
      ...
      <form action="<?php $wishlist->the_url_edit(); ?>" method="post" class="wl-form" id="wl-items-form">
        ...
        <div class="wl-row">
          <table width="100%" cellpadding="0" cellspacing="0" class="wl-actions-table">
            <tbody>
              <tr>
                <td class="wl-td-header">
                  <select class="wl-sel move-list-sel" name="wlupdateaction" id="wleditaction1" aria-label="Actions">
                    ...
                    <option value="quantity-add-to-cart">
                      <?php _e( 'Update Quantities and Add to Cart', 'wc_wishlist' ); ?></option>
                    <?php endif; ?>
                ...
                <td>
                  <button
                    class="btn button small wl-but wl-add-to btn-apply"><?php _e( 'Apply Action', 'wc_wishlist' ); ?></button>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <table class="cart wl-table manage  shop_table shop_table_responsive" cellspacing="0">
          <thead class="wl-th-product">
            <tr>
              <th class="check-column">
                <label>
                  <span class="wl-th-product__heading wl-th-product__heading--is-visually-hidden">Select All</span>
                  <input type="checkbox" name="" value="" />
                </label>
              </th>
              <th class="product-remove">
                <span class="wl-th-product__heading wl-th-product__heading--is-visually-hidden">Remove</span>
              </th>
              ...
              <th class="product-quantity ctr">
                <?php echo apply_filters( 'wc_wishlist_show_previously_ordered_column_heading', WC_Wishlists_Settings::get_setting( 'wc_wishlist_show_previously_ordered_column_heading', __( 'Ordered', 'wc_wishlist' ) ) ); ?>
              </th>
              <?php endif; ?>
              <?php if ( ( apply_filters( 'woocommerce_wishlist_purchases_enabled', true, $wishlist ) ) ): ?>
              <th>
                <span class="wl-th-product__heading wl-th-product__heading--is-visually-hidden">Add to Cart</span>
              </th>
              <?php endif; ?>
              <th>
                <span class="wl-th-product__heading wl-th-product__heading--is-visually-hidden">Heading</span>
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr class="cart_table_item">
              <td class="check-column">
                <label>
                  <span class="wl-th-product__heading wl-th-product__heading--is-visually-hidden">Select Item</span>
              ...
              <td class="product-remove">
                <a rel="nofollow"
                  ...
                  class="remove wlconfirm" title="<?php _e( 'Remove this item from your wishlist', 'wc_wishlist' ); ?>"
                  ...
                  <div class="remove__container">
                    <svg class="icon icon--trash" aria-hidden="true" focusable="false">
              ...
              <td class="product-quantity"
                data-title="<?php _e( 'Quantity', 'wc_wishlist' ); ?>"
                data-min="<?php echo $_product->get_min_purchase_quantity(); ?>"
                ...
                <label class="product-quantity__label">
              ...
              <td class="product-purchase">
                ...
                <a rel="nofollow"
                  ...
                  id="wl-add-to-cart-btn"
                  class="btn btn--primary post-card__btn wishlist-add-to-cart-button alt"><?php _e( 'Add to Cart', 'wc_wishlist' ); ?></a>
                <?php elseif ( $_product->get_type() == 'external' ) : ?>
                <a rel="nofollow" href="<?php echo esc_url( $_product->add_to_cart_url() ); ?>" rel="nofollow"
        ...
        <div class="wl-row">
          <table width="100%" cellpadding="0" cellspacing="0" class="wl-actions-table">
            <tbody>
              <tr>
                <td>
                  <select class="wl-sel move-list-sel" name="wleditaction2" id="wleditaction2" aria-label="Actions">
                    <option selected="selected"><?php _e( 'Actions', 'wc_wishlist' ); ?></option>
                    <option value="quantity"><?php _e( 'Update Quantities', 'wc_wishlist' ); ?></option>
                    <?php if ( !class_exists( 'WC_Catalog_Visibility_Options' ) ): ?>
                    <option value="add-to-cart"><?php _e( 'Add to Cart', 'wc_wishlist' ); ?></option>
                ...
                <td class="product-purchase">
                  <a rel="nofollow"
                    ...
                    class="btn btn--primary post-card__btn alt wl-add-all"><?php _e( 'Add All To Cart', 'wc_wishlist' ); ?></a>
                </td>
                <?php endif; ?>
              </tr>
        ...
        <form action="" enctype="multipart/form-data" method="post">
          ...
          <div class="form-row">
            ...
            <table class="wl-rad-table">
              ...
              <tr>
                <td>
                  <input type="radio" name="wishlist_sharing" id="rad_pub" value="Public"
                    <?php checked( 'Public', $sharing ); ?>>
                </td>
                <td><label for="rad_pub"><?php _e( 'Public', 'wc_wishlist' ); ?>
                    <span class="wl-small">-
                      <?php _e( 'Anyone can search for and see this list. You can also share using a link.', 'wc_wishlist' ); ?></span></label>
                </td>
              </tr>
              <?php endif; ?>
              ...
              <tr>
                <td>
                  <input type="radio" name="wishlist_sharing" id="rad_shared" value="Shared"
                    <?php checked( 'Shared', $sharing ); ?>>
                </td>
                <td><label for="rad_shared"><?php _e( 'Shared', 'wc_wishlist' ); ?>
                    <span class="wl-small">-
                      <?php _e( 'Only people with the link can see this list. It will not appear in public search results.', 'wc_wishlist' ); ?></span></label>
                </td>
              </tr>
              <?php endif; ?>
              ...
              <tr>
                <td>
                  <input type="radio" name="wishlist_sharing" id="rad_priv" value="Private"
                    <?php checked( 'Private', $sharing ); ?>>
                </td>
          ...
          <p class="form-row">
            <?php _e( 'Enter a name you would like associated with this list.  If your list is public, users can find it by searching for this name.', 'wc_wishlist' ); ?>
          </p>
          ...
          <div class="form-row">
            <table class="wl-rad-table">
              <tr>
                <td>
                  <input type="radio" id="rad_notification_yes" name="wishlist_owner_notifications" value="yes"
                    <?php checked( 'yes', $notifications ); ?>>
                </td>
                <td><label for="rad_notification_yes"><?php _e( 'Yes', 'wc_wishlist' ); ?>
                    <span class="wl-small">-
                      <?php _e( 'Send me an email if a price reduction occurs.', 'wc_wishlist' ); ?></span></label>
                </td>
              </tr>
              <tr>
                <td>
                  <input type="radio" id="rad_notification_no" name="wishlist_owner_notifications" value="no"
                    <?php checked( 'no', $notifications ); ?>>
                </td>
                <td><label for="rad_notification_no"><?php _e( 'No', 'wc_wishlist' ); ?>
                    <span class="wl-small">-
                      <?php _e( 'Do not send me an email if a price reduction occurs.', 'wc_wishlist' ); ?></span></label>
                </td>
              </tr>
            </table>
          </div>
