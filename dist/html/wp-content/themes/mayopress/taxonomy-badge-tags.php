<?php
/**
 * Duplicate of the Template for displaying product archives, including the main shop page which is a post type archive
 *
...
<div class="product-listing__container">
	...
	<?php
	Timber::render('templates/sidebar.twig', array('sidebar' => 'Product facets widget area', 'attributes' => 'data-animation="on" data-component="accordion" data-autoclose="true"', 'class_list' => 'flyout__container accordion js-accordion'));
	?>
	...
	if ( woocommerce_product_loop() ) {
		...
		echo '<p class="view__label sr-only">SORT BY:</p>';
